...
until winner_found != false
  ...
  loop do
    ...
    break if (x_choice.length == 2) && (x_choice[0].to_i in (0..2)) && (x_choice[1].to_i in (0..2)) && Game.board_layout[x_choice[0]][x_choice[1]] == '-'
  end
  ...
  loop do
    ...
    break if (o_choice.length == 2) && (o_choice[0].to_i in (0..2)) && (o_choice[1].to_i in (0..2)) && Game.board_layout[o_choice[0]][o_choice[1]] == '-'
  end
